<template>
  <div>
    <div class="container">
      <p class="p_type1">To stop the degradation of the planet's natural environment and to build a future in which
      ...
      <span v-for="item in items" :id="('number' + item)">{{item}} </span>
    </div>
    <div class="container">
      正常情况(chrome和火狐下active伪类都没问题)：
      <a href="javascript:" class="active-btn">按下</a>
      包含JS(火狐下没有触发active伪类)：
      <a href="javascript:" id="button" class="active-btn" @mousedown="clickevent">按下</a>
    </div>
    <div class="container" style="resize: horizontal;overflow: hidden;height:200px;line-height: 200px;">
    ...
    <div class="container" style="width:50%;">
      ...
      <div class="box inline-block">
        ...
        <p>
          display:inline-block具有收缩特性，但是，当（例如这里的）描述文字超过一行显示的时候，其会这行，不会让自身的宽度超过父级容器的可用空间的，但是，width:max-content就不是酱样子哦咯！表现得好像设置了white-space:nowrap一样，科科！</p>
      </div>
      ...
      <div class="box min-content">
        <img src="../assets/logo.png" id="minContentIMG">
    ...
    <div class="container" style="width:50%">
      <div class="box_style2">
        <div class="child">高度96px</div>
      </div>
      <div class="box_style2 rel">
        <div class="child">高度156px</div>
      </div>
    </div>
    <div class="container" style="width:50%">
    ...
    <div class="container" style="width:50%">
      <div class="table">
        <div class="td">
          ...
          <div class="element">
            <p>
              display:table-cell其他一些应用，例如，两栏自适应布局，垂直居中效果等等都是可以通过其他技术手段模拟出来的，但是，根据列表个数自动等宽的效果，其他CSS是很难模拟的，尤其当需要兼容IE8浏览器的时候。</p>
          </div>
    ...
    <div class="container" style="width:50%;">
      <div style="background: cornflowerblue;line-height: 400px;font-size: 0;"><img src="../assets/makelei.png"
                                                                                    style="vertical-align: middle;">
      </div>
    </div>

    <div class="container">
      <div style="text-align: justify;max-width:500px;background-color:#E5EDFF;line-height: 0;" class="outline">
        <img src="../assets/makelei.png" style="width:130px;height:120px;display: inline-block">
        <img src="../assets/makelei.png" style="width:130px;height:120px;display: inline-block">
        <img src="../assets/makelei.png" style="width:130px;height:120px;display: inline-block">
        <img src="../assets/makelei.png" style="width:130px;height:120px;display: inline-block">
        <span class="justify-fix"></span>
        <span class="justify-fix"></span>
        <span class="justify-fix"></span>FUCKYOU
      </div>
    </div>
  </div>
</template>
...
<style scoped rel="stylesheet/less" lang="less" type="text/less">
  ...
  p.p_type1:first-line {
    background-color: yellow;
  }

  p.p_type2:first-letter {
    background-color: yellow;
  }
